...
1. **Download**  
   Download the file `[PC_Remote_Control.exe](https://github.com/burakozdelen/Telegram-PC-Remote-Control/releases/tag/Telegram-PC-Remote-Control-v1.0)`.
...
1. **İndirin**  
   `[PC_Remote_Control.exe](https://github.com/burakozdelen/Telegram-PC-Remote-Control/releases/tag/Telegram-PC-Remote-Control-v1.0)` dosyasını indirin.
